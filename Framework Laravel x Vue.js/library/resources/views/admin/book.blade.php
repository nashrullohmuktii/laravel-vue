        ...
        <div class="col-md-3 col-sm-6 col-xs-12" v-for="book in filteredList">
            <div class="info-box" v-on:click="editData(book)">
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">Rp@{{ formatToCurrency(book.price) }}<small></small></span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <form method="post" :action="actionUrl" autocomplete="off" @submit="submitForm($event, book.id)">
                    ...
                    <div class="modal-footer justify-content-between" >
                        <button type="button" class="btn bg-danger btn-default" v-if="editStatus" v-on:click="deleteData(book.id)">Delete</button>
        ...
        methods: {
            ...
            deleteData(id) {
                ...
                axios.post(this.actionUrl + '/' + id, { _method: 'DELETE' }).then(response => {
                    alert('Data has been removed cuy!');
