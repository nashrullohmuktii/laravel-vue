...
<body>
	...
	<?php
		...
		if(isset($_POST['Submit'])) {
			...
			include_once("connect.php");
			$query = "INSERT INTO bukus (isbn, judul, tahun, id_penerbit, id_pengarang, id_katalog, qty_stok, harga_pinjam) VALUES ('$isbn', '$judul', '$tahun', '$id_penerbit', '$id_pengarang', '$id_katalog', '$qty_stok', '$harga_pinjam')";
