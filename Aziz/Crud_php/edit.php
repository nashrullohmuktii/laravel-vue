...
<body>
	...
	<?php
		...
		if(isset($_POST['update'])) {
			...
			$result = mysqli_query($mysqli, "UPDATE bukus SET judul = '$judul',tahun = '$tahun' , id_pengarang = '$id_pengarang',id_penerbit = '$id_penerbit', id_katalog = '$id_katalog', qty_stok = '$qty_stok', harga_pinjam = '$harga_pinjam' WHERE isbn = '$isbn';");
