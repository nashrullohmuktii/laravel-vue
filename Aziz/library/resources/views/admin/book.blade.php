    ...
    <div class="row">
        <div class="col-md-5 offset-md-3">
            <div class="input-group mb-3">
                ...
                <input type="text" class="from-control" autocomplete="off" placeholder="Search from title" v-model="search" style="width: 80%">
            </div>
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12" v-for="book in filteredlist">
            <div class="info-box" v-on:click="editData(book)">
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">Rp.@{{numerWithSpaces(book.price)}},-<small></small></span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <form method="post" :action="actionUrl" autocomplete="off" @submit="submitForm($event, book.id)">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Price</label>
                            <input type="number" name="price" class="form-control" placeholder=" Enter Year" required="" :value="book.price">
                        </div>
                    </div>
                    <!-- /.card-body -->
