...
<body> 
    ...
    <div class="container">
    <h1 class="fw-bolder">Tambah Pengarang</h1>
    <?php
    ...
    ?>
        <form action="" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control" id="exampleFormControlInput1" placeholder="email@jhondoe.com">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Telp Pengarang</label>
                <input type="text" name="telp" class="form-control" id="exampleFormControlInput1" placeholder="08123456789">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Alamat Pengarang</label>
                <input type="alamat" name="alamat" class="form-control" id="exampleFormControlInput1" placeholder="Bandung">
            </div>
