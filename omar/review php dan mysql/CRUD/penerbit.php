...
<a href="addpenerbit.php">Add New Penerbit</a><br/><br/>
    ...
    <?php  
        while($penerbit_data = mysqli_fetch_array($penerbit)) {         
            ...
            echo "<td><a class='btn btn-primary' href='editpenerbit.php?id=$penerbit_data[id]'>Edit</a> | <a class='btn btn-danger' href='deletepenerbit.php?id=$penerbit_data[id]'>Delete</a></td></tr>";        
        }
    ?>
    </table>
</body>
